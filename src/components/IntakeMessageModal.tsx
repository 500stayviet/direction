    ...
    >
      <div className="-mx-2 rounded-2xl bg-gray-50 px-1 py-1.5">
        <textarea
          ...
          autoFocus
          rows={6}
          className="w-full resize-none overflow-y-auto rounded-xl border border-blue-400 bg-white p-2 text-[15px] font-bold leading-snug text-gray-800 outline-none"
        />
