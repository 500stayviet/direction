...
export function PhoneChip({
  ...
  return (
    <PhoneLink
      ...
      showIcon={false}
      className={[
        "relative z-[1] ml-auto !shrink-0 !gap-1 rounded-md border border-gray-200 bg-gray-50 px-1.5 py-0.5 !text-[16px] !font-bold !leading-none !tracking-tight tabular-nums",
