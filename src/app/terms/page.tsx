...
const REVISION = "시행일 2026. 8. 1. · 개정 2026. 8. 11.";
    ...
    <>
      ...
      <Section title="1. 서비스 성격">
        <p>
          ...
          (모바일 웹)입니다. 고객·매물·방문 일정(네비)·전화·길안내 연결을
          정리하는 선택적 도구이며, 누구나 의무적으로 써야 하는 서비스가
          아닙니다. 서비스 운영을 위해 광고가 표시될 수 있으며, 향후 유료
          요금제·부가 기능이 도입될 수 있습니다.
        </p>
      </Section>
      <Section title="2. 이용 자격 및 동의">
        <p>
          회원가입·로그인·팀 공유(공유 코드 생성·참여)·「팀 공유하기」 사용·서비스
          이용을 시작하면 본 약관·개인정보 안내·광고 안내·면책 내용에 동의한
          것으로 봅니다. 동의하지 않으면 이용을 중단해 주세요.
        </p>
      </Section>
      <Section title="3. 계정 · 업장명 · 최소 입력">
        <p>
          아이디는 중복 확인을 거쳐 가입하며, 삭제된 아이디는 재사용할 수
          없습니다. 계정 정보와 고객·매물·일정 등 입력 데이터의 정확성·수집
          적법성·보관·백업 및 외부 전달 결과는 이용자 책임입니다.
        </p>
        <p>
      ...
      <Section title="4. 팀 공유 (계정 → 공간 → 항목)">
        <p>
          팀 공유는{" "}
          <strong className="font-bold text-gray-800">지역·상호 이름 자동
          공유가 아닙니다.</strong>{" "}
          순서는 다음과 같습니다.
        </p>
        <ul className="list-disc space-y-1 pl-4">
          ...
          <li>
            ...
            공간에 합류한 뒤에도 고객 리스트·매물 리스트·네비(방문 일정)에서
            이용자가 「팀 공유하기」를 켠 항목만 팀원에게 공개됩니다.
          </li>
        </ul>
        <p>
          한 번 팀 공유된 데이터는{" "}
          ...
          탈퇴만으로 자동 소멸되지 않고 공유 공간에 남을 수 있습니다. 팀 공유
          시작(코드 생성·참여) 및 「팀 공유하기」 사용은 본 조항에 대한 동의로
          봅니다.
        </p>
      </Section>
      <Section title="5. 조건 매칭 · 삭제">
        <p>
          고객·매물 상세의 「조건에 맞는 매물/고객」에서 삭제하면, 해당 항목이
          본인 리스트에서 제외되도록 처리됩니다. 삭제는 화면에서 바로 반영되며,
          서버에는 복구·분쟁·업장 보호를 위해 소프트 삭제 등으로 남을 수
          있습니다. 동일 전화·주소 등으로 중복 가능성이 있으면 안내할 수
          있으나, 최종 등록·삭제 판단은 이용자 책임입니다.
        </p>
      </Section>
      <Section title="6. 회원 탈퇴·악의적 삭제">
        <p>
          ...
          보관·복원될 수 있습니다. 이용자가 고의·악의로 업장 업무 데이터를 영구
          소멸시키려는 행위에는{" "}
...
function PrivacyTerms() {
  return (
    <>
      ...
      <Section title="6. 쿠키·로컬 저장">
        <p>
          로그인 유지, 화면 로그인 상태, 목록 캐시, 스플래시·안내 닫기, (광고
          사용 시) 광고·트래픽 측정 목적으로 쿠키 또는 로컬/세션 저장소가
          사용될 수 있습니다. 브라우저 설정으로 제한할 수 있으나 일부 기능이
          제한될 수 있습니다.
        </p>
      </Section>
      <Section title="7. 문의">
        <p>
          계정·데이터·개인정보 관련 문의는 서비스 내 안내 메일(
          <a
    ...
    <>
      ...
      <Section title="4. 팀 공유·탈퇴·삭제">
        <p>
          ...
          악의적 영구 소멸에 동의하지 않음은 이용약관에 따릅니다. 운영자의
