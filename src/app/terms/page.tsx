...
const REVISION = "시행일 2026. 8. 1. · 개정 2026. 8. 21.";
    ...
    <>
      ...
      <Section title="4. 팀 공유 (계정 → 공간 → 항목)">
        ...
        <p>
          ...
          있습니다(백그라운드 푸시는 브라우저·기기 설정에 따르며, 푸시
          구독·권한이 있을 때 조건 매칭 등을 보낼 수 있습니다). 팀 공유
      ...
      <Section title="5. 조건 매칭 · 알림 · 삭제">
        <p>
          ...
          같은 업장(팀 공유 공간)에 속한 고객·매물끼리 조건이 맞을 때{" "}
          <strong className="font-bold text-gray-800">사이트내 매칭</strong>
          으로 알려 드릴 수 있으며, 팀원이 「팀 공유하기」를 켜지 않은
          항목도 업장 매칭 풀에 포함될 수 있습니다(리스트 비공개는
          유지). 알림·웹 푸시는 해당 고객·매물 소유자에게만 갑니다.
        </p>
        <p>
          ...
          남을 수 있습니다. 웹 푸시 구독 정보(엔드포인트·암호화 키)는 알림
          발송·구독 해제 목적으로 저장됩니다.
        </p>
        <p>
          고객 희망입주일·매물 임대희망일의{" "}
          ...
          매일 카드·홈에서 기한 안내가 뜰 수 있습니다. 원터치 네비에 넘기는
          주소는 시 이름을{" "}
      ...
      <Section title="9. 서비스 변경·중단">
        <p>
          ...
          경우 제외). 업장 사이트내 매칭·웹 푸시 등 기능 범위는 운영상
          변경될 수 있습니다.
        </p>
      </Section>
    </>
    ...
    <>
      ...
      <Section title="3. 수집·이용 항목">
        ...
        <ul className="list-disc space-y-1 pl-4">
          ...
          <li>
            ...
            팀 공유·조건 매칭·사이트내 매칭 신규 알림의 읽음/미확인, 팀원
            화면에서의 항목 숨김 등 UI 선호가 계정에 저장되어 같은 계정으로
            로그인하는 기기(폰·PC 등)에서 맞춰질 수 있습니다.
          </li>
          <li>
            <strong className="font-bold text-gray-800">웹 푸시</strong> —
            알림 수신을 켠 경우 브라우저 푸시 구독 정보(엔드포인트, 암호화
            키)가 저장·발송·구독 해제 목적으로 처리됩니다.
          </li>
          <li>
      ...
      <Section title="4. 이용 목적">
        ...
        <ul className="list-disc space-y-1 pl-4">
          ...
          <li>신규 공유·매칭·사이트내 매칭 알림·읽음 상태·목록 숨김 등 이용 편의</li>
          <li>웹 푸시 알림 발송(구독 시)</li>
          <li>
    ...
    <>
      ...
      <Section title="1. 광고 사용 목적">
        <p>
          ...
          제3자 광고를 게재할 수 있습니다. 환경 설정·광고 승인·게시자 ID
          (`NEXT_PUBLIC_ADSENSE_*`) 설정 전에는 광고가 표시되지 않을 수
          있습니다. 향후 유료 요금제와 병행될 수 있습니다.
        </p>
      </Section>
